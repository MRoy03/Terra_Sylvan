    ...
    <div className="w-full max-w-md mx-auto">
      <div className="backdrop-blur-xl bg-forest-950/70 border border-forest-800/50 rounded-3xl p-8 shadow-2xl">
        ...
        <div className="flex items-center gap-3 mb-6">
          ...
          <span className="text-forest-600 text-sm">or sign in with email</span>
          <div className="flex-1 h-px bg-forest-800" />
        </div>
        ...
        <p className="text-center text-forest-500 text-sm mt-6">
          No account yet?{' '}
          <Link href="/register" className="text-forest-400 hover:text-forest-200 underline underline-offset-2 transition-colors">
